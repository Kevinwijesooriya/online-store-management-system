              ...
              <div className="flex flex-wrap">
                  ...
                  <div className="relative w-full mb-3">
                      ...
                      <input type="text" className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                       id="itemname"value={this.state.name} onChange={this.onChangetname} readOnly required/>
                   </div>
                  ...
                  <div className="relative w-full mb-3">
                      ...
                      <input type="email" className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                       id="itemcolor" readOnly value={this.state.email} onChange={this.onChangetemail} required/>
                      </div>
                  ...
                  <div className="relative w-full mb-3">
                 <button> <a type="submit" className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">Udpate</a></button>
                  </div>
                  </div>
