  ...
  const [salaryplan, updateSalaryplan] = useState([]);
    ...
    const loadsalaryplan = async () => {
      const res = await axios.get
          (`http://localhost:5000/admin/${customerid}`)
            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                 ...
                 <button>  <a href = {"/admin/profile/update/" + salaryplan._id}
              ...
              <div className="text-center mt-12">
                ...
                <div className="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                  ...
                  {salaryplan.loginType}
                </div>
                <div className="mb-2 text-blueGray-600 mt-10">
                  <i className="fas fa-phone-square-alt mr-2 text-lg py-4 text-blueGray-400"></i>
                 {salaryplan.phone}
                </div>
                <div className="mb-2 text-blueGray-600">
                  <i className="fas fa-envelope-square mr-2 text-lg text-blueGray-400"></i>
                  {salaryplan.email}
                </div>
                <div className="mb-2 text-blueGray-600">
